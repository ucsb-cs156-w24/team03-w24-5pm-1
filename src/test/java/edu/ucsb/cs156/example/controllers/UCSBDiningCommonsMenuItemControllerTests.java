...
public class UCSBDiningCommonsMenuItemControllerTests extends ControllerTestCase {
    ...
    @WithMockUser(roles = { "ADMIN", "USER" })
    @Test
    public void admin_tries_to_delete_non_existant_UCSBDiningCommonsMenuItemand_gets_right_error_message()
            throws Exception {
        // arrange
        ...
        public void admin_can_edit_an_existing_UCSBDiningCommonsMenuItem()throws Exception
    {
       ...
       // LocalDateTime ldt1 = LocalDateTime.parse("2022-01-03T00:00:00");
        ...
        verify(ucsbDiningCommonsMenuItemRepository, times(1)).save(ucsbDiningCommonsMenuItemEdited); // should be saved
                                                                                                   // with correct user
        String responseString = response.getResponse().getContentAsString();
    ...
    @WithMockUser(roles = { "ADMIN", "USER" })
    @Test
    public void admin_cannot_edit_UCSBDiningCommonsMenuItemthat_does_not_exist() throws Exception {
        // arrange
       ...
       //LocalDateTime ldt1 = LocalDateTime.parse("2022-01-03T00:00:00");
        ...
        UCSBDiningCommonsMenuItem ucsbDiningCommonsMenuItemEdited = UCSBDiningCommonsMenuItem.builder()
        .name("rice")
        .diningCommonsCode("diningCommonsCode3")
        .station("station3")
        .build();
