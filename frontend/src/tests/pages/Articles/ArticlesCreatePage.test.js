...
describe("ArticlesCreatePage tests", () => {
    ...
    test("when you fill in the form and hit submit, it makes a request to the backend", async () => {
        ...
        fireEvent.change(explanationField, { target: { value: 'testtt!' } });
        fireEvent.change(emailField, { target: { value: 'test@test.edu' } });
        fireEvent.change(dateAddedField, { target: { value: '2022-02-02T12:00' } });
