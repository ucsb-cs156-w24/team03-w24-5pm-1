...
describe("ArticlesEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Is populated with the data provided", async () => {
            ...
            expect(explanationField).toHaveValue("test1!");
            expect(emailField).toHaveValue("test1@ucsb.edu");
        ...
        test("Changes when you click Update", async () => {
            ...
            fireEvent.change(explanationField, { target: { value: 'test2!' } });
            fireEvent.change(emailField, { target: { value: 'test2@ucsb.edu' } });
            fireEvent.change(dateAddedField, { target: { value: '2022-11-02T12:00' } });

            fireEvent.click(submitButton);

            await waitFor(() => expect(mockToast).toBeCalled());
            expect(mockToast).toBeCalledWith("Article Updated - id: 1 title: test2");
