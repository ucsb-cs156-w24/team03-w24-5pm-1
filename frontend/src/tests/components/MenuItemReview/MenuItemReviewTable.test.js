...
describe("MenuItemReviewTable tests", () => {
  ...
  test("Has the expected column headers, content and buttons for admin user", () => {
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-itemId`)).toHaveTextContent("100");
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-comments`)).toHaveTextContent("good enough");

    expect(screen.getByTestId(`${testId}-cell-row-1-col-id`)).toHaveTextContent("2");
    expect(screen.getByTestId(`${testId}-cell-row-1-col-itemId`)).toHaveTextContent("101");
    expect(screen.getByTestId(`${testId}-cell-row-1-col-reviewerEmail`)).toHaveTextContent("jhinckley@ucsb.edu");
    expect(screen.getByTestId(`${testId}-cell-row-1-col-stars`)).toHaveTextContent("0");
    expect(screen.getByTestId(`${testId}-cell-row-1-col-dateReviewed`)).toHaveTextContent("1981-03-30T14:27:00");
    expect(screen.getByTestId(`${testId}-cell-row-1-col-comments`)).toHaveTextContent("I don't like jellybeans");
