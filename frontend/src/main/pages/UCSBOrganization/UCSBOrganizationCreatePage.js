...
export default function UCSBOrganizationCreatePage({storybook=false}) {
  ...
  const onSuccess = (organization) => {
    toast(`New organization Created - id: ${organization.orgCode}, orgTranslation: ${organization.orgTranslation}, orgTranslationShort: ${organization.orgTranslationShort}, inactive: ${organization.inactive} `);
  }
